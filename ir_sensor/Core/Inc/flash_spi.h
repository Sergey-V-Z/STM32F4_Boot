...
class flash
  {
   public:
    ...
    void W25qxx_WritePage(uint32_t Page_Address, uint8_t *pBuffer, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_PageSize);
    void W25qxx_WriteSector(uint32_t Sector_Address, uint8_t *pBuffer, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_SectorSize);
    void W25qxx_WriteBlock(uint32_t Block_Address, uint8_t* pBuffer, uint32_t OffsetInByte, uint32_t NumByteToWrite_up_to_BlockSize);
